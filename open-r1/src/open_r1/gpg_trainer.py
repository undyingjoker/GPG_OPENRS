...
class GPGTrainer(GRPOTrainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        if self.args.adjust_gd:
            loss = loss / max((1.0 - self._metrics[mode]['lr_ratio'][-1]), 0.05)
    ...
    def _generate_and_score_completions(
        ...
        num_reward_samples = rewards.numel() / self.num_generations
        ...
        self._metrics[mode]['num_reward_samples'].append(num_reward_samples)
        self._metrics[mode]['lr_ratio'].append(num_identical_reward_groups/num_reward_samples)
